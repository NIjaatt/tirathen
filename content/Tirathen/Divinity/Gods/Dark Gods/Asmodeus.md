**Asmodeus** (pronounced Az-Mo-Dee-Us) is the god of devils. He is the most powerful of the nine archdevils that rule over [[Hell]], and the only one of Hell's archdevils that bears divinity. It was he who penned the contract of godhood, within which his followers believe is hidden the means for their patron's rise to supremacy. Once upon a time, he was known by a different name and title, but it was forgotten when he turned his back on his fellow Celestial gods.
...
#### Boons
**Minor Boon**: Pleased by your talent for manipulation, Asmodeus amplifies your skills. Once, when you fail at the Diplomacy check to make a significant or consequential Request, you can cast [_suggestion_](https://2e.aonprd.com/Spells.aspx?ID=1693) on the target of your Request, suggesting the same course of action. This is a divine innate spell using your class DC or spell DC, whichever is higher.

**Moderate Boon**: Your eyes glow red like embers and your skin takes on a crimson tone. You gain [darkvision](https://2e.aonprd.com/MonsterAbilities.aspx?ID=59) and [fire resistance 5](https://2e.aonprd.com/Rules.aspx?ID=2318).
...
#### Curses
**Minor Curse**: Asmodeus’s flames burn you with great malice. You gain [weakness](https://2e.aonprd.com/Rules.aspx?ID=2317) 5 to fire.

**Moderate Curse**: Asmodeus forces your compliance. You can’t voluntarily back out of an agreement or contract or go back on your word, though you need to follow only the letter of the agreement, not the spirit.

**Major Curse**: Asmodeus has taken note of the chaos you have wrought. You receive an ancient wound that feels older than time itself. You become permanently [drained](https://2e.aonprd.com/Conditions.aspx?ID=68) 4, and nothing short of another intercession can remove the condition. Your wound aches fiercely whenever you perform a particularly disruptive act, causing you to become [sickened](https://2e.aonprd.com/Conditions.aspx?ID=91) 1.