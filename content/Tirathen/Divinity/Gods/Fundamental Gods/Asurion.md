**Asurion** (pronounced Ace-uur-eon) is the god of knowledge, and magic.

The All-Seeing Eye is a member of the [[Celestial Pantheon]], specifically one of the Eight Makers that created a sentient creature. Asurion created the [[Gnome]].
...
#### Boons
**Minor Boon**: Asurion casts a powerful spell to help you in a pinch. Once, Asurion casts a spell 1 rank higher than the highest-rank spell you can cast. If you can’t cast spells, Asurion casts a 1st-rank spell to help you.

**Moderate Boon**: Asurion grants you insight into the secrets of magic. Add one spell from a different tradition of magic to your spell list. You still must learn it or add it to your repertoire normally.

**Major Boon**: You are granted supreme magical knowledge and mastery. If you are a prepared spellcaster, you can switch one of your prepared spells for another spell you could have prepared in that slot; if you are a spontaneous spellcaster, you can switch one of the spells in your spell repertoire for another spell you could have chosen for your repertoire instead. In either case, you make this switch by using a single action, which has the concentrate trait. (If you are neither a prepared nor a spontaneous spellcaster, Asurion won’t grant you his major boon.)

#### Curses
**Minor Curse**: The secrets of magic become mentally taxing. You are permanently [stupefied](https://2e.aonprd.com/Conditions.aspx?ID=94) 1.

**Moderate Curse**: Your magic wars against itself like Asurion’s duelling halves. Whenever you cast a spell, attempt a DC 11 flat check. On a failure, if your spell was harmful, you instead cast a beneficial spell of the same level on your intended targets, and if it was beneficial, you instead cast a harmful spell of the same level on your intended targets. If the spell benefited some targets and harmed others, you cast a spell of the same level that switches who benefited (for instance, changing a heal spell that harmed undead and healed the living to a harm spell that healed undead and harmed the living). You still lose the spell slot for the spell you were trying to cast.

**Major Curse**: Asurion severs your connection to magic. You lose all your spellcasting abilities and cannot gain any future spellcasting.